                    ...
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div>
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end mb-6">
                                <div><h3 className="text-base sm:text-lg font-semibold text-slate-800 leading-tight">DAFTAR KAMAR</h3>{userRole === 'admin' && <p className="text-sm text-slate-500">Klik pada kotak kamar untuk membuka menu aksi.</p>}</div>
